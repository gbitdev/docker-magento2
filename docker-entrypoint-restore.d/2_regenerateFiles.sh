...
gulp -f tools/gulpfile.esm.js setup && gulp -f tools/gulpfile.esm.js babel styles svg && echo "Theme files compiled" 
gulp -f tools/gulpfile.esm.js setup && gulp -f tools/gulpfile.esm.js babel --prod && echo "JS minified" 
